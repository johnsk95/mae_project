...
def main(args):
    ...
    if args.eval:
        humanlabels_to_onehot = pickle.load(open('../ContextualBias/DeepFashion/humanlabels_to_onehot.pkl', 'rb'))
        onehot_to_humanlabels = dict((y,x) for x,y in humanlabels_to_onehot.items())
        biased_classes_mapped = pickle.load(open('../ContextualBias/DeepFashion/biased_classes_mapped.pkl', 'rb'))
        ...
        # print('scores list shape: ', scores_list.shape) # (6985,85)
        ...
        for k in range(len(biased_classes_list)):
            ...
            # print('exclusive: ', labels_list_raw[exclusive+other, b].shape)
            
            # recall
            cooccur_AP = recall3(labels_list_raw[cooccur+other, b], scores_list[cooccur+other], b)
